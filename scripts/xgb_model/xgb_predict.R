...
output_files <- c('ie' = 'output/ie_xgb_slic/march_sv_landcovercorrected/ie_xgb_slic_2023.tif',
                  'probability' = 'output/ie_xgb_slic/march_sv_landcovercorrected/ie_xgb_slic_2023_prob.tif')
model_folder <- 'output/models/xgb slic v10'
