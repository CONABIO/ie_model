...
Se calculó en qué proporción coincide las respuestas (con consenso) de
los expertos y el valor del IIE de 2023.

El 29.3% no consideraron que existan zonas con Integridad Alta dentro de
la AP en la que laboran, lo cual es poco probable, ya que son zonas
protegidas, esto podría deberse al que el cuestionario implica un grado
de subjetividad en las respuestas de cada experto. Otra manera de
comparar el IIE 2023, considerando esta subjetividad, es comparando el
orden en el que evaluan las áreas, es decir que se cumpla que un área es
más/menos degradada que otra. Para ello seguimos los siguientes pasos
por cada AP:

1.  Dividir la AP en áreas de acuerdo al valor con consenso.

2.  Ordenar estas áreas.

3.  Calcular la mediana del IIE 2023 por área.

4.  Comparar que el valor de IIE 2023 de cada pixel sea menor a la
    mediana del área siguiente y mayor a la de la anterior.
...
seleccionó un conjunto de registros, provenientes del SNIB, de mamíferos
y aves de talla grande para la validación de clases altas de IIE. Por su
parte, la incidencia de ganadería se utilizó para la evaluación de IE
baja y muy baja.
...
degradación de lq que se predice con el IIE. Al respecto, uno de los
...
En cuanto a la comparación del orden de las categorías, el 39.33% del
...
en el orden del 53.3% (DE=24.2%), siendo las de mayor coincidencia
Barranca de Metztitlán (94.7%), La Montaña Malinche o Matlalcuéyatl
(88.7%), El Veladero (78.6%) y Lagunas de Zempoala (75.2%). Las de menor
coincidencia fueron Sierra Gorda de Guanajuato (12.8%), Sierra de
Huautla (18.7%), Mariposa Monarca (22.5%) e Iztaccíhuatl-Popocatépetl
(35.2%).

Si los expertos están en lo correcto parecería que el modelo de IIE
tiende a sobrestimar la Integridad de los Ecosistemas y entonces la
condición es menor a la estimada hasta el momento.
