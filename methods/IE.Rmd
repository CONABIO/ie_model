...
el territorio del que el o ella tenga conocimiento, esto se realizó
...
expertos que no asignaron respuesta a esa celda). Po último, se calculó
en qué proporción coincide las respuestas (con consenso) de los expertos
y el valor del IIE de 2023.
...
En promedio en todas las AP, el 37.4% (DE=28.7%) de celdas fueron
validadas, es decir, los expertos asignaron el mismo valor que el IIE.
Las AP con mayor coincidencia, fueron la Laguna de Zempoala, Insurgentes
Miguel Hidalgo y Costilla, y El Veladero. Y las AP con menor
coincidencia entre el consenso de expertos y el IIE fueron Grutas de
Cacahuamilpa, El Chico y Mariposa Monarca.

Al respecto, uno de los resultados que sobresalen de los patrones
observados en los mapas de las respuestas con consenso de expertos
versus los mapas del IIE 2023 es que, a pesar del alto impacto humano en
el centro del país, el 90% de las AP de la región CoSMoS presenta
pixeles con clase de Integridad Alta del IIE 2023, contrastando con el
58 % de las AP en los mapas de expertos.

Las únicas AP que no tuvieron clase de IE Alta en el IIE 2023, ni en el
consenso fueron el 10.5% de las AP (El Veladero y Grutas de
Cacahuamilpa). Si los expertos están en lo correcto parecería que el
modelo de IIE tiende a sobrestimar la Integridad de los Ecosistemas y
entonces la condición es menor a la estimada hasta el momento.
...
frecuencia en zonas con Integridad Alta de manera estadísticamente
significativa.
