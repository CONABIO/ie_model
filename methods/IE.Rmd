...
![](/Users/kasanchez/Documents/ie_model/images/modelo_flujo.png){width=70%}
...
ie <- rast('/Users/kasanchez/Documents/ie_model/output/ie_xgb_slic/march_sv/ie_xgb_slic_2023_march_sv.tif')
...
df_plot <- read.csv('/Users/kasanchez/Documents/ie_model/data/other/ie_by_zonas_pct.csv')
...
ggplot(df_plot,
       aes(x = factor(zonas_reducidas), fill = ie, y = pct)) + 
...
```{r ie_diff, echo=FALSE, message=FALSE}
library(ggplot2)
library(terra)
library(tidyterra)

r_diff_cat <- rast('/Users/kasanchez/Documents/ie_model/output/ie_xgb_slic/march_sv/ie_diff_2023_2018.tif')
